...
class App extends Component {
  ...
  getPotentialBuyers() {
    axios.get('https://joes-autos.herokuapp.com/api/buyers') // axios (GET)
    .then(res => this.setState({buyersToDisplay: res.data}) // setState with response -> buyersToDisplay
    )
  }

  sellCar(id) {
    axios.delete(`https://joes-autos.herokuapp.com/api/vehicles/${id}`)// axios (DELETE)
  ...
  filterByMake() {
    ...
    axios.get('https://joes-autos.herokuapp.com/api/vehicles?make=Ford')// axios (GET)
      .then(res => this.setState({vehiclesToDisplay: res.data}))
    // setState with response -> vehiclesToDisplay
  }
  ...
  filterByColor() {
    ...
    axios.get('https://joes-autos.herokuapp.com/api/vehicles?color=red')// axios (GET)
    .then(res => this.setState({vehiclesToDisplay: res.data}))
    // setState with response -> vehiclesToDisplay
  }

  updatePrice(priceChange, carId) {
    axios.put(`https://joes-autos.herokuapp.com/api/vehicles/${carId}/${priceChange}`)// axios (PUT)
    .then(res => this.setState({vehiclesToDisplay: res.data.vehicles}))
    // setState with response -> vehiclesToDisplay
  }
  ...
  axios.post('https://joes-autos.herokuapp.com/api/vehicles')// axios (POST)
  .then(this.setState({vehiclesToDisplay: res.data.vehicles}))
  // setState with response -> vehiclesToDisplay
}
